...
public class Shape {
    ...
    public static void main(String[] args) {
        ...
        Shape myShape = new Shape("My puzzle.Shape", ShapeOption.TRIANGLE);
        myShape.outputData();
    ...
    public void outputData() {
        ...
        System.out.println("puzzle.Shape is: " + this.shapeOption);
    ...
    public static Shape getRandomShape() {
        return new Shape("Random puzzle.Shape", ShapeOption.SQUARE);
    }
}
