...
public class GCD {
    ...
    /**
     * The greatest common divisor (math.GCD), also called highest common factor (HCF) of N numbers is the
     ...
     * @return an integer representing the math.GCD of the given positive integers.
     */
